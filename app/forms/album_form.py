...
class AlbumForm(FlaskForm):
    ...
    cd = IntegerField('CD Quantity', validators=[DataRequired()])
    vinyl = IntegerField('Vinyl Quantity', validators=[DataRequired()])
    cassette = IntegerField('Cassette Quantity', validators=[DataRequired()])
    digital = IntegerField('Digital Quantity', validators=[DataRequired()])
