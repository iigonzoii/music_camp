...
def seed_albums():
    ...
    album_three = Album(
        user_id=6, band='ArtistThree',title='albumThree',product_type='vinyl',cover_image_url='https://firebasestorage.googleapis.com/v0/b/musiccamp-88aaa.appspot.com/o/musicCampHipHopVinylCover.jpg?alt=media&token=d379f3e9-15bb-4045-ac4d-fee49461ea35',description='This is a description about a vinyl album', producer='awesome producer',genre='hip-hop/rap',tags='trap',price=4.22,stock=10)
    album_four= Album(
